...
def gerar_link_pagamento_essential(user_id):
    sdk = mercadopago.SDK("APP_USR-5966197263163161-070317-6ab5cace0b168a1161e2acb15eb3e35c-1883683525")

    payment_data = {
        "items": [
            {"id": "1", "title": "Plano Essential", "quantity": 1, "currency_id": "BRL", "unit_price": 79.90}
        ],
...
def gerar_link_pagamento_advanced(user_id):
    sdk = mercadopago.SDK("APP_USR-5966197263163161-070317-6ab5cace0b168a1161e2acb15eb3e35c-1883683525")

    payment_data = {
        "items": [
            {"id": "1", "title": "Plano Advanced", "quantity": 1, "currency_id": "BRL", "unit_price": 109.90}
        ],
